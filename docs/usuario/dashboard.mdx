...
<ImageDiv src="/img/arquos_files/Landing-Pages/landing-page-with-session.png" alt="Dashboard" />
...
<ImageDiv src="/img/arquos_files/Profile-User/user-options.png" alt="Opciones" />
